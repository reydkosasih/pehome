...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-4">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
            <!--begin::Heading-->
            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?= base_url('demo1/') ?>assets/media/misc/menu-header-bg.jpg')">
                <!--begin::Title-->
                ...
                <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                    ...
                    <div class="d-flex flex-column px-9">
                        ...
                        <div class="text-center px-4">
                            <img class="mw-100 mh-200px" alt="image" src="<?= base_url('demo1/') ?>assets/media/illustrations/sketchy-1/1.png" />
                        </div>
                        <!--end::Illustration-->
                    </div>
                    <!--end::Wrapper-->
    ...
    <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img src="<?= base_url('assets/custom/media/profilepic/') ?>" class="rounded-3" alt="user" />
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="<?= base_url('assets/custom/media/profilepic/') ?>" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
                    <div class="d-flex flex-column">
                        <!-- <div class="fw-bold d-flex align-items-center fs-5"><?= $tbl_user['nama_depan'] . ' ' . $tbl_user['nama_belakang'] ?></div>
                        <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $tbl_user['email'] ?></a> -->
                    </div>
                    <!--end::Username-->
                </div>
            </div>
            ...
            <div class="menu-item px-5">
                <a href="<?= site_url('user/my_profile') ?>" class="menu-link px-5">My Profile</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5">
